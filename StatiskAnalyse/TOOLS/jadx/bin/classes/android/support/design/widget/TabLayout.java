...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            this.mIndicatorAnimator.cancel();
            animateIndicatorToPosition(this.mSelectedPosition, Math.round((PhotoViewAttacher.DEFAULT_MIN_SCALE - this.mIndicatorAnimator.getAnimatedFraction()) * ((float) this.mIndicatorAnimator.getDuration())));
        }
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle == null || selectedTitle.getWidth() <= 0) {
                ...
                if (this.mSelectionOffset > 0.0f && this.mSelectedPosition < getChildCount() - 1) {
                    ...
                    left = (int) ((this.mSelectionOffset * ((float) nextTitle.getLeft())) + ((PhotoViewAttacher.DEFAULT_MIN_SCALE - this.mSelectionOffset) * ((float) left)));
                    right = (int) ((this.mSelectionOffset * ((float) nextTitle.getRight())) + ((PhotoViewAttacher.DEFAULT_MIN_SCALE - this.mSelectionOffset) * ((float) right)));
                }
            }
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (startLeft != targetLeft || startRight != targetRight) {
                ...
                animator.setFloatValues(0.0f, PhotoViewAttacher.DEFAULT_MIN_SCALE);
    ...
    private void updateTabViewLayoutParams(LayoutParams lp) {
        if (this.mMode == 1 && this.mTabGravity == 0) {
            lp.width = 0;
            lp.weight = PhotoViewAttacher.DEFAULT_MIN_SCALE;
            return;
        }
        lp.width = -2;
        lp.weight = 0.0f;
