...
class CircularBorderDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        float halfBorderWidth = this.mPaint.getStrokeWidth() / PhotoViewAttacher.DEFAULT_MAX_SCALE;
