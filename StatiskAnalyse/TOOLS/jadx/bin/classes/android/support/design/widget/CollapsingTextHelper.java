...
final class CollapsingTextHelper {
    ...
    void setExpansionFraction(float fraction) {
        fraction = MathUtils.constrain(fraction, 0.0f, (float) PhotoViewAttacher.DEFAULT_MIN_SCALE);
    ...
    private void calculateBaseOffsets() {
        ...
        switch (collapsedAbsGravity & g.if) {
            case 48:
            ...
            case 80:
                ...
                break;
            default:
                this.mCollapsedDrawY = ((float) this.mCollapsedBounds.centerY()) + (((this.mTextPaint.descent() - this.mTextPaint.ascent()) / PhotoViewAttacher.DEFAULT_MAX_SCALE) - this.mTextPaint.descent());
                break;
        }
        switch (collapsedAbsGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) {
            case 1:
                this.mCollapsedDrawX = ((float) this.mCollapsedBounds.centerX()) - (width / PhotoViewAttacher.DEFAULT_MAX_SCALE);
                break;
            case 5:
        ...
        switch (expandedAbsGravity & g.if) {
            case 48:
            ...
            case 80:
                ...
                break;
            default:
                this.mExpandedDrawY = ((float) this.mExpandedBounds.centerY()) + (((this.mTextPaint.descent() - this.mTextPaint.ascent()) / PhotoViewAttacher.DEFAULT_MAX_SCALE) - this.mTextPaint.descent());
                break;
        }
        switch (expandedAbsGravity & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK) {
            case 1:
                this.mExpandedDrawX = ((float) this.mExpandedBounds.centerX()) - (width / PhotoViewAttacher.DEFAULT_MAX_SCALE);
                break;
            case 5:
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTextToDraw != null && this.mDrawTitle) {
            ...
            if (this.mScale != PhotoViewAttacher.DEFAULT_MIN_SCALE) {
    ...
    private void setInterpolatedTextSize(float textSize) {
        ...
        boolean z = USE_SCALING_TEXTURE && this.mScale != PhotoViewAttacher.DEFAULT_MIN_SCALE;
        this.mUseTexture = z;
        if (this.mUseTexture) {
    ...
    private void calculateUsingTextSize(float textSize) {
        ...
        if (this.mText != null) {
            ...
            if (isClose(textSize, this.mCollapsedTextSize)) {
                ...
                this.mScale = PhotoViewAttacher.DEFAULT_MIN_SCALE;
    ...
    private static int blendColors(int color1, int color2, float ratio) {
        float inverseRatio = PhotoViewAttacher.DEFAULT_MIN_SCALE - ratio;
