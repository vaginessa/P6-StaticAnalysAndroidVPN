...
public class PagerTitleStrip extends ViewGroup implements Decor {
    ...
    public PagerTitleStrip(Context context, AttributeSet attrs) {
        ...
        this.mLastKnownPositionOffset = ImageViewTouchBase.ZOOM_INVALID;
    ...
    void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        if (currOffset > PhotoViewAttacher.DEFAULT_MIN_SCALE) {
            currOffset -= PhotoViewAttacher.DEFAULT_MIN_SCALE;
        }
