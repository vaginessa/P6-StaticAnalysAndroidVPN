...
class DonutAnimatorCompatProvider implements AnimatorProvider {
    ...
    private static class DonutFloatValueAnimator implements ValueAnimatorCompat {
        ...
        private Runnable mLoopRunnable = new Runnable() {
            public void run() {
                float fraction = (((float) (DonutFloatValueAnimator.this.getTime() - DonutFloatValueAnimator.this.mStartTime)) * PhotoViewAttacher.DEFAULT_MIN_SCALE) / ((float) DonutFloatValueAnimator.this.mDuration);
                if (fraction > PhotoViewAttacher.DEFAULT_MIN_SCALE || DonutFloatValueAnimator.this.mTarget.getParent() == null) {
                    fraction = PhotoViewAttacher.DEFAULT_MIN_SCALE;
                }
                DonutFloatValueAnimator.this.mFraction = fraction;
                DonutFloatValueAnimator.this.notifyUpdateListeners();
                if (DonutFloatValueAnimator.this.mFraction >= PhotoViewAttacher.DEFAULT_MIN_SCALE) {
