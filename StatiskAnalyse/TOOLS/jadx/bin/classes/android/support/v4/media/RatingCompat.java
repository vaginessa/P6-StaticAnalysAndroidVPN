...
public final class RatingCompat implements Parcelable {
    ...
    public static RatingCompat newHeartRating(boolean hasHeart) {
        return new RatingCompat(1, hasHeart ? PhotoViewAttacher.DEFAULT_MIN_SCALE : 0.0f);
    }

    public static RatingCompat newThumbRating(boolean thumbIsUp) {
        return new RatingCompat(2, thumbIsUp ? PhotoViewAttacher.DEFAULT_MIN_SCALE : 0.0f);
    }
    ...
    public boolean hasHeart() {
        ...
        if (this.mRatingValue != PhotoViewAttacher.DEFAULT_MIN_SCALE) {
            z = false;
        }
        return z;
    }
    ...
    public boolean isThumbUp() {
        if (this.mRatingStyle == 2 && this.mRatingValue == PhotoViewAttacher.DEFAULT_MIN_SCALE) {
            return true;
        }
        return false;
    }
