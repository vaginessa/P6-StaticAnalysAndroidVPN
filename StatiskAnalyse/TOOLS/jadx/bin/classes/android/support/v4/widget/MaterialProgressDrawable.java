    ...
    private static class Ring {
        ...
        private void drawTriangle(Canvas c, float startAngle, float sweepAngle, Rect bounds) {
            if (this.mShowArrow) {
                ...
                this.mArrow.lineTo((((float) this.mArrowWidth) * this.mArrowScale) / PhotoViewAttacher.DEFAULT_MAX_SCALE, ((float) this.mArrowHeight) * this.mArrowScale);
        ...
        public void setInsets(int width, int height) {
            ...
            if (this.mRingCenterRadius <= 0.0d || minEdge < 0.0f) {
                insets = (float) Math.ceil((double) (this.mStrokeWidth / PhotoViewAttacher.DEFAULT_MAX_SCALE));
            } else {
                insets = (float) (((double) (minEdge / PhotoViewAttacher.DEFAULT_MAX_SCALE)) - this.mRingCenterRadius);
            }
    ...
    private void setupAnimators() {
        ...
        animation.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationRepeat(Animation animation) {
                ...
                MaterialProgressDrawable.this.mRotationCount = (MaterialProgressDrawable.this.mRotationCount + PhotoViewAttacher.DEFAULT_MIN_SCALE) % 5.0f;
            }
        });
