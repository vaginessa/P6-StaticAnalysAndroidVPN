...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    Animation loadAnimation(Fragment fragment, int transit, boolean enter, int transitionStyle) {
        ...
        switch (styleIndex) {
            case 1:
                return makeOpenCloseAnimation(this.mHost.getContext(), 1.125f, PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.0f, PhotoViewAttacher.DEFAULT_MIN_SCALE);
            case 2:
                return makeOpenCloseAnimation(this.mHost.getContext(), PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.975f, PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.0f);
            case 3:
                return makeOpenCloseAnimation(this.mHost.getContext(), 0.975f, PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.0f, PhotoViewAttacher.DEFAULT_MIN_SCALE);
            case 4:
                return makeOpenCloseAnimation(this.mHost.getContext(), PhotoViewAttacher.DEFAULT_MIN_SCALE, 1.075f, PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.0f);
            case 5:
                return makeFadeAnimation(this.mHost.getContext(), 0.0f, PhotoViewAttacher.DEFAULT_MIN_SCALE);
            case 6:
                return makeFadeAnimation(this.mHost.getContext(), PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.0f);
            default:
