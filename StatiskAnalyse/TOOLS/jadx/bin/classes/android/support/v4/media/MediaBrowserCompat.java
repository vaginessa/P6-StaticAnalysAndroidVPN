...
public final class MediaBrowserCompat {
    ...
    static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            if (this.mState != 0) {
                throw new IllegalStateException("connect() called while not disconnected (state=" + getStateLabel(this.mState) + Separators.RPAREN);
            } else if (this.mServiceBinderWrapper != null) {
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException("getServiceComponent() called while not connected (state=" + this.mState + Separators.RPAREN);
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException("getRoot() called while not connected(state=" + getStateLabel(this.mState) + Separators.RPAREN);
        }
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException("getExtras() called while not connected (state=" + getStateLabel(this.mState) + Separators.RPAREN);
        }
        ...
        public Token getSessionToken() {
            ...
            throw new IllegalStateException("getSessionToken() called while not connected(state=" + this.mState + Separators.RPAREN);
        }
