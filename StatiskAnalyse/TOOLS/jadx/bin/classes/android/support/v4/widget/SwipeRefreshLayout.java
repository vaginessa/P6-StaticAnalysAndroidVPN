...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        this.mTotalDragDistance = ImageViewTouchBase.ZOOM_INVALID;
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                ...
                SwipeRefreshLayout.this.mProgress.setArrowScale(PhotoViewAttacher.DEFAULT_MIN_SCALE - interpolatedTime);
            }
        };
    ...
    private void startScaleDownAnimation(AnimationListener listener) {
        this.mScaleDownAnimation = new Animation() {
            public void applyTransformation(float interpolatedTime, Transformation t) {
                SwipeRefreshLayout.this.setAnimationProgress(PhotoViewAttacher.DEFAULT_MIN_SCALE - interpolatedTime);
            }
        };
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case 0:
                ...
                if (initialDownY != ImageViewTouchBase.ZOOM_INVALID) {
            ...
            case 2:
                ...
                if (y != ImageViewTouchBase.ZOOM_INVALID) {
    ...
    private float getMotionEventY(MotionEvent ev, int activePointerId) {
        ...
        if (index < 0) {
            return ImageViewTouchBase.ZOOM_INVALID;
        }
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float dragPercent = Math.min(PhotoViewAttacher.DEFAULT_MIN_SCALE, Math.abs(overscrollTop / this.mTotalDragDistance));
        ...
        if (!this.mScale) {
            ViewCompat.setScaleX(this.mCircleView, PhotoViewAttacher.DEFAULT_MIN_SCALE);
            ViewCompat.setScaleY(this.mCircleView, PhotoViewAttacher.DEFAULT_MIN_SCALE);
        }
        if (this.mScale) {
            setAnimationProgress(Math.min(PhotoViewAttacher.DEFAULT_MIN_SCALE, overscrollTop / this.mTotalDragDistance));
        }
        ...
        this.mProgress.setArrowScale(Math.min(PhotoViewAttacher.DEFAULT_MIN_SCALE, adjustedPercent));
