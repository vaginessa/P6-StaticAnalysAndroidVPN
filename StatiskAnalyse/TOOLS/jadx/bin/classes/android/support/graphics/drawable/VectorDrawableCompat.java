...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private static class VPath {
        ...
        public String NodesToString(PathDataNode[] nodes) {
            ...
            for (int i = 0; i < nodes.length; i++) {
                result = result + nodes[i].type + Separators.COLON;
    ...
    private static class VFullPath extends VPath {
        float mFillAlpha = PhotoViewAttacher.DEFAULT_MIN_SCALE;
        int mFillColor = 0;
        int mFillRule;
        float mStrokeAlpha = PhotoViewAttacher.DEFAULT_MIN_SCALE;
        int mStrokeColor = 0;
        ...
        float mTrimPathEnd = PhotoViewAttacher.DEFAULT_MIN_SCALE;
    ...
    private static class VGroup {
        ...
        private float mScaleX = PhotoViewAttacher.DEFAULT_MIN_SCALE;
        private float mScaleY = PhotoViewAttacher.DEFAULT_MIN_SCALE;
    ...
    private static class VPathRenderer {
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int w, int h, ColorFilter filter) {
            ...
            if (matrixScale != 0.0f) {
                ...
                if (!(fullPath.mTrimPathStart == 0.0f && fullPath.mTrimPathEnd == PhotoViewAttacher.DEFAULT_MIN_SCALE)) {
                    float start = (fullPath.mTrimPathStart + fullPath.mTrimPathOffset) % PhotoViewAttacher.DEFAULT_MIN_SCALE;
                    float end = (fullPath.mTrimPathEnd + fullPath.mTrimPathOffset) % PhotoViewAttacher.DEFAULT_MIN_SCALE;
        ...
        private float getMatrixScale(Matrix groupStackedMatrix) {
            float[] unitVectors = new float[]{0.0f, PhotoViewAttacher.DEFAULT_MIN_SCALE, PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.0f};
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mTmpBounds.width() > 0 && this.mTmpBounds.height() > 0) {
            ...
            if (!(canvasSkewX == 0.0f && canvasSkewY == 0.0f)) {
                canvasScaleX = PhotoViewAttacher.DEFAULT_MIN_SCALE;
                canvasScaleY = PhotoViewAttacher.DEFAULT_MIN_SCALE;
            }
            ...
            if (scaledWidth > 0 && scaledHeight > 0) {
                ...
                if (needMirroring()) {
                    ...
                    canvas.scale(ImageViewTouchBase.ZOOM_INVALID, PhotoViewAttacher.DEFAULT_MIN_SCALE);
                }
