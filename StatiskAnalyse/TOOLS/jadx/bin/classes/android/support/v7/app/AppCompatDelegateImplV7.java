        ...
        if (mode != null) {
                ...
                if (this.mIsFloating) {
                    ...
                    this.mShowActionModePopup = new Runnable() {
                        public void run() {
                            ...
                            AppCompatDelegateImplV7.this.mFadeAnim = ViewCompat.animate(AppCompatDelegateImplV7.this.mActionModeView).alpha(PhotoViewAttacher.DEFAULT_MIN_SCALE);
                            AppCompatDelegateImplV7.this.mFadeAnim.setListener(new ViewPropertyAnimatorListenerAdapter() {
                                public void onAnimationEnd(View view) {
                                    ViewCompat.setAlpha(AppCompatDelegateImplV7.this.mActionModeView, PhotoViewAttacher.DEFAULT_MIN_SCALE);
                                    AppCompatDelegateImplV7.this.mFadeAnim.setListener(null);
                                    AppCompatDelegateImplV7.this.mFadeAnim = null;
                                }
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    this.mFadeAnim = ViewCompat.animate(this.mActionModeView).alpha(PhotoViewAttacher.DEFAULT_MIN_SCALE);
