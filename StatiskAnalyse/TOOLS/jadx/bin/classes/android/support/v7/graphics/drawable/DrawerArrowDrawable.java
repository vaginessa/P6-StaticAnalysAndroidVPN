...
public class DrawerArrowDrawable extends Drawable {
    ...
    public void setBarThickness(float width) {
        if (this.mPaint.getStrokeWidth() != width) {
            ...
            this.mMaxCutForBarSize = (float) (((double) (width / PhotoViewAttacher.DEFAULT_MAX_SCALE)) * Math.cos((double) ARROW_HEAD_ANGLE));
            invalidateSelf();
        }
    }
    ...
    public void draw(Canvas canvas) {
        ...
        float arrowHeadBarLength = lerp(this.mBarLength, (float) Math.sqrt((double) ((this.mArrowHeadLength * this.mArrowHeadLength) * PhotoViewAttacher.DEFAULT_MAX_SCALE)), this.mProgress);
        ...
        float arrowEdge = (-arrowShaftLength) / PhotoViewAttacher.DEFAULT_MAX_SCALE;
        this.mPath.moveTo(arrowEdge + arrowShaftCut, 0.0f);
        this.mPath.rLineTo(arrowShaftLength - (PhotoViewAttacher.DEFAULT_MAX_SCALE * arrowShaftCut), 0.0f);
        ...
        canvas.translate((float) bounds.centerX(), (float) (((double) ((float) ((((int) ((((float) bounds.height()) - (3.0f * barThickness)) - (this.mBarGap * PhotoViewAttacher.DEFAULT_MAX_SCALE))) / 4) * 2))) + ((((double) barThickness) * 1.5d) + ((double) this.mBarGap))));
        if (this.mSpin) {
