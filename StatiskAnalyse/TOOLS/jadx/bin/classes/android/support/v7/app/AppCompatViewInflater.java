...
class AppCompatViewInflater {
    ...
    private static class DeclaredOnClickListener implements OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context, @NonNull String name) {
            ...
            throw new IllegalStateException("Could not find method " + this.mMethodName + "(View) in a parent or ancestor Context for android:onClick " + "attribute defined on view " + this.mHostView.getClass() + (id == -1 ? "" : " with id '" + this.mHostView.getContext().getResources().getResourceEntryName(id) + Separators.QUOTE));
        }
    }
