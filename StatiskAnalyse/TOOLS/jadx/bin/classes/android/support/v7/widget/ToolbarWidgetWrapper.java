...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int visibility, long duration) {
        return ViewCompat.animate(this.mToolbar).alpha(visibility == 0 ? PhotoViewAttacher.DEFAULT_MIN_SCALE : 0.0f).setDuration(duration).setListener(new ViewPropertyAnimatorListenerAdapter() {
