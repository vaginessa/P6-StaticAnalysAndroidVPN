...
public class SwitchCompat extends CompoundButton {
    ...
    private Layout makeLayout(CharSequence text) {
        ...
        return new StaticLayout(transformed, this.mTextPaint, transformed != null ? (int) Math.ceil((double) Layout.getDesiredWidth(transformed, this.mTextPaint)) : 0, Alignment.ALIGN_NORMAL, PhotoViewAttacher.DEFAULT_MIN_SCALE, 0.0f, true);
    }
                ...
                switch (this.mTouchMode) {
                    ...
                    case 2:
                        ...
                        if (thumbScrollRange != 0) {
                            ...
                            dPos = thumbScrollOffset > 0.0f ? PhotoViewAttacher.DEFAULT_MIN_SCALE : ImageViewTouchBase.ZOOM_INVALID;
                        }
                        if (ViewUtils.isLayoutRtl(this)) {
                            dPos = -dPos;
                        }
                        float newPos = constrain(this.mThumbPosition + dPos, 0.0f, PhotoViewAttacher.DEFAULT_MIN_SCALE);
    ...
    private void animateThumbToCheckedState(final boolean newCheckedState) {
        ...
        this.mPositionAnimator = new ThumbAnimation(this.mThumbPosition, newCheckedState ? PhotoViewAttacher.DEFAULT_MIN_SCALE : 0.0f);
        ...
        this.mPositionAnimator.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                if (SwitchCompat.this.mPositionAnimator == animation) {
                    SwitchCompat.this.setThumbPosition(newCheckedState ? PhotoViewAttacher.DEFAULT_MIN_SCALE : 0.0f);
    ...
    public void setChecked(boolean checked) {
        ...
        cancelPositionAnimator();
        setThumbPosition(checked ? PhotoViewAttacher.DEFAULT_MIN_SCALE : 0.0f);
    }
    ...
    private int getThumbOffset() {
        float thumbPosition;
        if (ViewUtils.isLayoutRtl(this)) {
            thumbPosition = PhotoViewAttacher.DEFAULT_MIN_SCALE - this.mThumbPosition;
        } else {
    ...
    public void jumpDrawablesToCurrentState() {
        if (VERSION.SDK_INT >= 11) {
            ...
            cancelPositionAnimator();
            setThumbPosition(isChecked() ? PhotoViewAttacher.DEFAULT_MIN_SCALE : 0.0f);
        }
    }
