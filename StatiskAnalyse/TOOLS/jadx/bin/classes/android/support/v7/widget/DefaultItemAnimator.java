...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    private void animateRemoveImpl(final ViewHolder holder) {
        ...
        animation.setDuration(getRemoveDuration()).alpha(0.0f).setListener(new VpaListenerAdapter() {
            ...
            public void onAnimationEnd(View view) {
                ...
                ViewCompat.setAlpha(view, PhotoViewAttacher.DEFAULT_MIN_SCALE);
    ...
    private void animateAddImpl(final ViewHolder holder) {
        ...
        animation.alpha(PhotoViewAttacher.DEFAULT_MIN_SCALE).setDuration(getAddDuration()).setListener(new VpaListenerAdapter() {
            public void onAnimationStart(View view) {
    ...
    private void animateChangeImpl(final ChangeInfo changeInfo) {
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0.0f).translationY(0.0f).setDuration(getChangeDuration()).alpha(PhotoViewAttacher.DEFAULT_MIN_SCALE).setListener(new VpaListenerAdapter() {
                public void onAnimationStart(View view) {
                ...
                public void onAnimationEnd(View view) {
                    ...
                    ViewCompat.setAlpha(newView, PhotoViewAttacher.DEFAULT_MIN_SCALE);
    ...
    private boolean endChangeAnimationIfNecessary(ChangeInfo changeInfo, ViewHolder item) {
        ...
        ViewCompat.setAlpha(item.itemView, PhotoViewAttacher.DEFAULT_MIN_SCALE);
    ...
    public void endAnimations() {
        ...
        for (i = this.mPendingAdditions.size() - 1; i >= 0; i--) {
            ...
            ViewCompat.setAlpha(item2.itemView, PhotoViewAttacher.DEFAULT_MIN_SCALE);
