...
public class zzd extends com.google.android.gms.internal.zzfk.zza implements zzo {
    ...
    private class zzd extends zzhz {
        ...
        public void zzbn() {
            ...
            if (zzg != null) {
                final Drawable zza = zzp.zzbx().zza(this.zzBv.mActivity, zzg, this.zzBv.zzBi.zzBM.zzpw, this.zzBv.zzBi.zzBM.zzpx);
                zzid.zzIE.post(new Runnable(this) {
                    final /* synthetic */ zzd zzBz;

                    public void run() {
                        this.zzBz.zzBv.mActivity.getWindow().setBackgroundDrawable(zza);
                    }
                });
            }
        }
    ...
    protected void zzv(boolean z) throws zza {
        ...
        if (z) {
            ...
            this.zzoM.zzhe().zza(new com.google.android.gms.internal.zzja.zza(this) {
                final /* synthetic */ zzd zzBv;
            ...
            if (this.zzBi.url != null) {
                ...
                this.zzoM.loadDataWithBaseURL(this.zzBi.zzBF, this.zzBi.zzBH, "text/html", Key.STRING_CHARSET_NAME, null);
            } else {
