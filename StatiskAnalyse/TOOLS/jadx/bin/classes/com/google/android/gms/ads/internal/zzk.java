...
public class zzk extends zzc implements zzdo {
    ...
    private float zzpm;
    private String zzpn = ("background" + hashCode() + Separators.DOT + "png");
    ...
    private class zzb extends zzhz {
        ...
        public void zzbn() {
            ...
            final AdOverlayInfoParcel adOverlayInfoParcel = new AdOverlayInfoParcel(this.zzpp, this.zzpp, this.zzpp, this.zzpp.zzot.zzqo.zzBD, requestedOrientation, this.zzpp.zzot.zzqj, this.zzpp.zzot.zzqo.zzEP, interstitialAdParameterParcel);
            zzid.zzIE.post(new Runnable(this) {
                final /* synthetic */ zzb zzps;

                public void run() {
                    zzp.zzbt().zza(this.zzps.zzpp.zzot.context, adOverlayInfoParcel);
                }
            });
        }
    }
