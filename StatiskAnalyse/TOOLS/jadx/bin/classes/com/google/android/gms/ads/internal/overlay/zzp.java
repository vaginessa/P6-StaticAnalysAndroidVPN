...
public class zzp {
    ...
    private final zzig zzCc = new zzb().zza("min_1", Double.MIN_VALUE, WeightedLatLng.DEFAULT_INTENSITY).zza("1_5", WeightedLatLng.DEFAULT_INTENSITY, 5.0d).zza("5_10", 5.0d, 10.0d).zza("10_20", 10.0d, 20.0d).zza("20_30", 20.0d, 30.0d).zza("30_max", 30.0d, Double.MAX_VALUE).zzgK();
