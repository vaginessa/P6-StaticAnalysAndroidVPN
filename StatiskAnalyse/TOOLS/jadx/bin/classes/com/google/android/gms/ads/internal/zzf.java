...
public class zzf extends zzc {
    ...
    public boolean zza(zzhs com_google_android_gms_internal_zzhs, final zzhs com_google_android_gms_internal_zzhs2) {
            ...
            if (this.zzot.zzbN()) {
                if (com_google_android_gms_internal_zzhs2.zzBD != null) {
                    ...
                    if (com_google_android_gms_internal_zzhs2.zzbY()) {
                        ...
                        com_google_android_gms_internal_zzhs2.zzBD.zzhe().zza(new zzja.zzb(this) {
                            final /* synthetic */ zzf zzoP;

                            public void zzbf() {
                                this.zzoP.zzov.zza(this.zzoP.zzot.zzqn, com_google_android_gms_internal_zzhs2).zza(com_google_android_gms_internal_zzhs2.zzBD);
                            }
                        });
                    }
                }
