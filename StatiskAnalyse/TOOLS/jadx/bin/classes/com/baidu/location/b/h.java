...
public class h implements f {
    ...
    class b {
        ...
        boolean b(a aVar) {
            return this.c.if(a(aVar)) == 0 && aVar.a < Math.max(this.a.a, this.b.a) + 1.0E-8d && aVar.a > Math.min(this.a.a, this.b.a) - 1.0E-8d && aVar.b < Math.max(this.a.b, this.b.b) + 1.0E-8d && aVar.b > Math.min(this.a.b, this.b.b) - 1.0E-8d;
        }
    }
    ...
    private h() {
        ...
        for (int i = 0; i < length - 1; i++) {
            this.bB.add(new b(this, new a(this, bC[i][0] * 100000.0d, bC[i][1] * 100000.0d), new a(this, bC[i + 1][0] * 100000.0d, bC[i + 1][1] * 100000.0d)));
        }
    }
    ...
    public boolean for(double d, double d2) {
        try {
            ...
            while (it.hasNext()) {
                ...
                int i2 = if(bVar.a(aVar));
                int i3 = if(bVar.a.b - aVar.b);
                int i4 = if(bVar.b.b - aVar.b);
                int i5 = (i2 <= 0 || i3 > 0 || i4 <= 0) ? i : i + 1;
                if (i2 < 0 && i4 <= 0 && i3 > 0) {
                    i5--;
                }
                i = i5;
