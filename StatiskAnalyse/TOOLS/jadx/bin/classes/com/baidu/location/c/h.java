...
final class h implements b {
    private static final String[] b = new String[]{"CoorType", "Time", "LocType", "Longitude", "Latitude", "Radius", "NetworkLocationType", "Country", "CountryCode", "Province", "City", "CityCode", "District", "Street", "StreetNumber", "PoiList", "LocationDescription"};
        ...
        public a(String[] strArr) {
            ...
            while (i < strArr.length) {
                if (strArr[i].equals("-loc")) {
                    ...
                    for (int i3 = 0; i3 < split.length; i3++) {
                        if (split[i3].startsWith("cl=")) {
                            ...
                            for (String split3 : split2) {
                                String[] split4 = split3.split(Separators.SEMICOLON);
                                if (split4.length >= 2) {
                    ...
                    String[] split5 = strArr[i + 1].split(Separators.SEMICOLON);
                    if (split5.length > 0) {
    ...
    static Cursor a(BDLocation bDLocation) {
        ...
        Object matrixCursor = new MatrixCursor(b);
        ...
        if (poiList == null) {
            ...
            for (int i = 0; i < poiList.size(); i++) {
                ...
                stringBuffer.append(poi.getId()).append(Separators.SEMICOLON).append(poi.getName()).append(Separators.SEMICOLON).append(poi.getRank()).append(";|");
            }
                ...
                if (str5 != null) {
                    try {
                        ...
                        for (String str82 : split) {
                            String[] split2 = str82.split(Separators.SEMICOLON);
                            if (split2.length >= 3) {
    ...
    static String a(BDLocation bDLocation, int i) {
        ...
        return str + String.format(Locale.US, "&pack=%s&sdk=%.3f", new Object[]{c.bn, Float.valueOf(f.bi)});
    }
    ...
    static String[] a(com.baidu.location.h.h hVar, com.baidu.location.h.f fVar, BDLocation bDLocation, String str, boolean z, int i) {
        ArrayList arrayList = new ArrayList();
        StringBuffer stringBuffer = new StringBuffer();
        if (hVar != null) {
            stringBuffer.append(com.baidu.location.h.b.cW().new(hVar));
        }
        if (fVar != null) {
