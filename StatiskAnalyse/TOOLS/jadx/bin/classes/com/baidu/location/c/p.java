            ...
            if (jSONArray != null) {
                for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                    ...
                    try {
                        ...
                        stringBuffer2.append("(\"").append(str3).append("\",\"").append(str2).append("\",\"").append(str4).append("\",\"").append(str5).append("\",").append(obj).append(",").append(obj2).append(",").append(obj3).append(Separators.RPAREN);
