...
public final class e {
    ...
    private static final String do = "test.0";
    public static String int = (do().for() + "/baidu/tempdata");
    ...
    L_0x00b4:
        ...
        r0 = r9.for;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r5 = new com.baidu.location.b.a;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r6 = 0;
        r7 = "Auto";
    ...
    L_0x00f6:
        ...
        if (r5 == 0) goto L_0x00cd;
    L_0x00fc:
        r5 = r9.for;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r6 = new com.baidu.location.b.a;	 Catch:{ Exception -> 0x010a, all -> 0x0115 }
        r7 = 0;
        r8 = "Auto";
    ...
    L_0x011a:
        ...
        goto L_0x00ab;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.baidu.location.b.e.a():java.util.List");
    }
    ...
    private List int() {
        try {
            StorageManager storageManager = (StorageManager) this.if.getSystemService("storage");
                    ...
                    if (str != null && str.length() > 0) {
                        if ("mounted".equals(method2.invoke(storageManager, new Object[]{str}))) {
                            ...
                            if (VERSION.SDK_INT <= 19 && a(str)) {
                                this.for.add(new a(str, obj2 == null, obj2 != null ? "Internal Storage" : "External Storage"));
                            }
                        }
                    }
                }
                if (VERSION.SDK_INT >= 19) {
                    File[] externalFilesDirs = this.if.getExternalFilesDirs(null);
                    ...
                    while (i < externalFilesDirs.length && externalFilesDirs[i] != null) {
                        ...
                        for (a aVar : this.for) {
                            if (absolutePath.startsWith(aVar.do())) {
                                obj3 = 1;
                                break;
                            }
                        }
                        obj3 = null;
                        if (obj3 == null && absolutePath.indexOf(this.if.getPackageName()) != -1) {
                            arrayList.add(new a(absolutePath, true, "External Storage"));
                        }
                        i++;
                    }
                    this.for.clear();
                    this.for.addAll(arrayList);
                }
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String for() {
        List list = if();
        return (list == null || list.size() == 0) ? null : ((a) list.get(0)).do();
    }
